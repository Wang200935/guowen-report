...
const 頁面資料 = [
  {
    ...
    標籤: "國文分組報告",
    標題: "從港口據點到大臺南",
    副標題: "用四個關鍵轉折，看臺南如何一路從海港、府城、近代都市，走到今天兼具歷史與科技發展的城市。",
    重點: "這份簡報要講的不是古蹟導覽，而是城市角色如何改變。",
    階段: [
      ["01", "開港建城", "先因海港而興"],
      ["02", "府城定型", "行政與商業核心成形"],
      ["03", "近代轉型", "空間秩序重新設計"],
  ...
  },
  {
    ...
    標籤: "主線總覽",
    標題: "為什麼臺南最適合拿來講城市變遷？",
    副標題: "因為臺南不是只累積歷史，而是在不同時代裡，一次次改變自己的城市角色與空間樣貌。",
    時間線: [
      ["17 世紀", "開港建城期", "海港、貿易與政權讓城市雛形長出來"],
      ["清領時期", "府城成形期", "城牆、街區、官署與生活圈穩定"],
      ["19 世紀後期至日治", "近代化期", "拆城、修路、公共建設讓臺南變現代"],
      ["戰後至今", "再定位期", "文化保存與都市發展一起推進"],
    ],
    收束: "真正要回答的問題只有一個：臺南在不同時代，為什麼總能長出新的城市定位？",
  },
  {
    類型: "階段",
    標籤: "第一階段",
  ...
  },
  {
    ...
    結論: "今天的臺南，最大的特徵不是停在過去，而是把歷史和現代疊在一起。",
  },
  {
    類型: "統整",
    標籤: "統整頁",
    ...
    收束: "臺南最特別的地方，不只是保留歷史，而是一直透過變化活到今天。",
  },
  {
    類型: "結論",
    標籤: "結論",
    ...
    右側: [
      ["核心結論", "這座城市的價值，在於它持續改變自己。"],
      ["回答題目", "臺南最符合城市變遷歷史，因為每個時代都留下新的空間與定位。"],
      ["報告收束", "不是只看古蹟，而是看一座城市如何穿過不同時代。"],
    ],
  },
  {
    類型: "分工",
...
function 加條列(slide, 頁碼, items, left, top, width) {
  items.forEach((item, index) => {
    const y = top + index * 88;
    加形狀(slide, 頁碼, "ellipse", left, y + 10, 18, 18, 色票.青綠, 色票.透明, 0, "條列點");
    加文字(slide, 頁碼, item, left + 34, y, width - 34, 54, {
      字級: 17,
      顏色: 色票.紙白,
      字體: 內文字,
      角色: `條列-${index + 1}`,
...
function 加標籤欄(slide, 頁碼, 欄位, left, top, width) {
  欄位.forEach(([標題, 內容], index) => {
    ...
    加圓角卡(slide, 頁碼, left, y, width, 60, "#0F2A3DE6", "#27516E", `標籤卡-${index + 1}`);
    加文字(slide, 頁碼, 標題, left + 18, y + 12, 110, 20, {
      字級: 11,
      顏色: 色票.淺青,
      粗體: true,
      字體: 等寬字,
    ...
    加文字(slide, 頁碼, 內容, left + 18, y + 28, width - 36, 22, {
      字級: 15,
      顏色: 色票.紙白,
      粗體: true,
      字體: 內文字,
...
async function 做封面(presentation, data) {
  ...
  加形狀(slide, 頁碼, "rect", 0, 0, W, H, "#04101B72", 色票.透明, 0, "封面整體遮罩");
  加形狀(slide, 頁碼, "rect", 0, 0, 732, H, "#07192AE8", 色票.透明, 0, "封面左欄");
  加頁碼框(slide, 頁碼, data.標籤);
  加文字(slide, 頁碼, data.標題, 84, 116, 610, 126, {
    字級: 46,
    顏色: 色票.紙白,
    粗體: true,
    字體: 標題字,
  ...
  加文字(slide, 頁碼, data.副標題, 88, 264, 550, 94, {
    字級: 22,
    顏色: "#D7E4F2",
    字體: 內文字,
    角色: "封面副標題",
  });
  加圓角卡(slide, 頁碼, 88, 400, 470, 96, "#0A2135E6", "#2A5E7E", "封面重點卡");
  加文字(slide, 頁碼, "這次報告的主線", 116, 424, 160, 18, {
    字級: 12,
    顏色: 色票.淺青,
    粗體: true,
    字體: 等寬字,
  ...
  加文字(slide, 頁碼, data.重點, 116, 448, 402, 30, {
    字級: 18,
    顏色: 色票.紙白,
    粗體: true,
    字體: 內文字,
  ...
  加圓角卡(slide, 頁碼, 764, 112, 430, 470, "#081A29C8", "#25526E", "封面階段面板");
  加文字(slide, 頁碼, "四段主線", 800, 142, 180, 24, {
    字級: 15,
    顏色: 色票.淺青,
    粗體: true,
    字體: 等寬字,
  ...
  data.階段.forEach(([序號, 標題, 說明], index) => {
    ...
    加圓角卡(slide, 頁碼, 796, y, 364, 72, "#102A40E6", "#21455D", `封面階段卡-${index + 1}`);
    加文字(slide, 頁碼, 序號, 820, y + 16, 36, 24, {
      字級: 18,
      顏色: 色票.青綠,
      粗體: true,
      字體: 標題字,
    ...
    加文字(slide, 頁碼, 標題, 872, y + 14, 220, 22, {
      字級: 17,
      顏色: 色票.紙白,
      粗體: true,
      字體: 內文字,
    ...
    加文字(slide, 頁碼, 說明, 872, y + 40, 244, 18, {
      字級: 12,
      顏色: 色票.淺灰,
      字體: 內文字,
      角色: `封面階段說明-${index + 1}`,
  ...
  加文字(slide, 頁碼, "班級／組別／姓名", 88, 624, 220, 22, {
    字級: 14,
    顏色: "#D7E4F2",
    字體: 內文字,
    角色: "封面欄位",
...
async function 做總覽(presentation, data) {
  ...
  加頁碼框(slide, 頁碼, data.標籤);
  加文字(slide, 頁碼, data.標題, 84, 110, 820, 58, {
    字級: 34,
    顏色: 色票.墨黑,
    粗體: true,
    字體: 標題字,
  ...
  加文字(slide, 頁碼, data.副標題, 84, 184, 720, 58, {
    字級: 20,
    顏色: 色票.深海藍,
    字體: 內文字,
    角色: "總覽副標題",
  ...
  data.時間線.forEach(([時間, 標題, 說明], index) => {
    const x = 84 + index * 286;
    加圓角卡(slide, 頁碼, x, 314, 258, 220, "#FFFFFFE6", "#D6E7F4", `時間線卡-${index + 1}`);
    加文字(slide, 頁碼, 時間, x + 22, 336, 180, 20, {
      字級: 12,
      顏色: 色票.青綠,
      粗體: true,
      字體: 等寬字,
    ...
    加文字(slide, 頁碼, 標題, x + 22, 372, 212, 50, {
      字級: 22,
      顏色: 色票.墨黑,
      粗體: true,
      字體: 標題字,
    ...
    加文字(slide, 頁碼, 說明, x + 22, 436, 212, 58, {
      字級: 15,
      顏色: 色票.深海藍,
      字體: 內文字,
      角色: `時間線說明-${index + 1}`,
    ...
    if (index < 3) {
      加形狀(slide, 頁碼, "rect", x + 258, 420, 28, 3, 色票.青綠, 色票.透明, 0, `時間線連接-${index + 1}`);
    }
  });
  加圓角卡(slide, 頁碼, 84, 580, 1110, 70, "#0C2435", "#12384F", "總覽結語");
  加文字(slide, 頁碼, data.收束, 116, 604, 1048, 22, {
    字級: 18,
    顏色: 色票.紙白,
    粗體: true,
    字體: 內文字,
...
async function 做階段頁(presentation, 頁碼, data, 參考圖) {
  ...
  加形狀(slide, 頁碼, "rect", 0, 0, 694, H, "#071A2BD9", 色票.透明, 0, "左側閱讀區");
  加形狀(slide, 頁碼, "rect", 694, 0, W - 694, H, "#081625A8", 色票.透明, 0, "右側統一濾罩");
  加頁碼框(slide, 頁碼, data.標籤);
  加圓角卡(slide, 頁碼, 84, 110, 160, 34, "#10334B", "#1E5573", "年代膠囊");
  加文字(slide, 頁碼, data.年代, 106, 118, 116, 18, {
    字級: 12,
    顏色: 色票.淺青,
    粗體: true,
    字體: 等寬字,
  ...
  加文字(slide, 頁碼, data.標題, 84, 164, 556, 96, {
    字級: 34,
    顏色: 色票.紙白,
    粗體: true,
    字體: 標題字,
  ...
  加文字(slide, 頁碼, data.判斷, 84, 280, 548, 58, {
    字級: 20,
    顏色: 色票.淺灰,
    粗體: true,
    字體: 內文字,
  ...
  加條列(slide, 頁碼, data.要點, 84, 366, 520);
  加圓角卡(slide, 頁碼, 84, 622, 556, 54, "#10334BE8", "#295F83", "結論卡");
  加文字(slide, 頁碼, data.結論, 108, 639, 510, 18, {
    字級: 16,
    顏色: 色票.紙白,
    粗體: true,
    字體: 內文字,
  ...
  加標籤欄(slide, 頁碼, data.標籤欄, 768, 360, 420);
  加圓角卡(slide, 頁碼, 748, 100, 448, 204, "#071C2CA6", "#21455D", "圖像說明卡");
  加文字(slide, 頁碼, "這一段的觀察重點", 776, 126, 180, 20, {
    字級: 12,
    顏色: 色票.青綠,
    粗體: true,
    字體: 等寬字,
  ...
  加文字(slide, 頁碼, data.判斷, 776, 160, 388, 48, {
    字級: 18,
    顏色: 色票.紙白,
    粗體: true,
    字體: 內文字,
  ...
  加文字(slide, 頁碼, "右側影像不是裝飾，而是協助觀眾把城市角色、空間與定位的改變看得更直覺。", 776, 222, 388, 46, {
    字級: 14,
    顏色: 色票.淺灰,
    字體: 內文字,
    角色: "圖像說明副句",
...
async function 做統整頁(presentation, data) {
  ...
  加頁碼框(slide, 頁碼, data.標籤);
  加文字(slide, 頁碼, data.標題, 84, 108, 720, 56, {
    字級: 34,
    顏色: 色票.紙白,
    粗體: true,
    字體: 標題字,
  ...
  加文字(slide, 頁碼, data.副標題, 84, 178, 760, 48, {
    字級: 19,
    顏色: 色票.淺灰,
    字體: 內文字,
    角色: "統整副標題",
  ...
  data.卡片.forEach(([標題, 變化, 說明], index) => {
    ...
    加圓角卡(slide, 頁碼, x, 302, 338, 276, "#0D2236E9", "#204A65", `統整卡-${index + 1}`);
    加文字(slide, 頁碼, `0${index + 1}`, x + 24, 326, 28, 20, {
      字級: 18,
    ...
    加文字(slide, 頁碼, 標題, x + 64, 324, 226, 24, {
      字級: 18,
      顏色: 色票.紙白,
      粗體: true,
      字體: 內文字,
    ...
    加文字(slide, 頁碼, 變化, x + 24, 376, 290, 70, {
      字級: 24,
      顏色: 色票.紙白,
      粗體: true,
      字體: 標題字,
    ...
    加文字(slide, 頁碼, 說明, x + 24, 470, 290, 56, {
      字級: 15,
      顏色: 色票.淺灰,
      字體: 內文字,
      角色: `統整說明-${index + 1}`,
  ...
  加圓角卡(slide, 頁碼, 84, 614, 1110, 60, "#0F3045F2", "#2F617F", "統整收束卡");
  加文字(slide, 頁碼, data.收束, 112, 633, 1052, 20, {
    字級: 17,
    顏色: 色票.紙白,
    粗體: true,
    字體: 內文字,
...
async function 做結論頁(presentation, data) {
  ...
  加形狀(slide, 頁碼, "rect", 0, 0, 738, H, "#061A2CE8", 色票.透明, 0, "結論左欄");
  加頁碼框(slide, 頁碼, data.標籤);
  加文字(slide, 頁碼, data.標題, 84, 118, 560, 92, {
    字級: 40,
    顏色: 色票.紙白,
    粗體: true,
    字體: 標題字,
  ...
  加文字(slide, 頁碼, data.句子, 84, 262, 462, 214, {
    字級: 28,
    顏色: 色票.紙白,
    粗體: true,
    字體: 標題字,
  ...
  data.右側.forEach(([標題, 內容], index) => {
    const y = 150 + index * 156;
    加圓角卡(slide, 頁碼, 808, y, 362, 124, "#0A2133DE", "#285370", `結論右卡-${index + 1}`);
    加文字(slide, 頁碼, 標題, 834, y + 22, 140, 18, {
      字級: 12,
      顏色: index === 0 ? 色票.青綠 : index === 1 ? 色票.金色 : 色票.珊瑚,
      粗體: true,
      字體: 等寬字,
      角色: `結論右卡標題-${index + 1}`,
      檢查: false,
    });
    加文字(slide, 頁碼, 內容, 834, y + 48, 302, 52, {
      字級: 17,
      顏色: 色票.紙白,
      粗體: true,
      字體: 內文字,
