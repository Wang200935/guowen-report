...
function 加條列(slide, 頁碼, items, left, top, width) {
  items.forEach((item, index) => {
    const y = top + index * 114;
    加形狀(slide, 頁碼, "ellipse", left, y + 16, 22, 22, 色票.青綠, 色票.透明, 0, "條列點");
    加文字(slide, 頁碼, item, left + 46, y + 4, width - 46, 72, {
      字級: 21,
      顏色: 色票.紙白,
      字體: 內文字,
      角色: `條列-${index + 1}`,
...
function 加標籤欄(slide, 頁碼, 欄位, left, top, width) {
  欄位.forEach(([標題, 內容], index) => {
    const y = top + index * 108;
    加圓角卡(slide, 頁碼, left, y, width, 90, "#102A40F2", "#2C6B93", `標籤卡-${index + 1}`);
    加文字(slide, 頁碼, 標題, left + 24, y + 16, 180, 24, {
      字級: 14,
      顏色: 色票.淺青,
      粗體: true,
      字體: 等寬字,
    ...
    加文字(slide, 頁碼, 內容, left + 24, y + 44, width - 48, 34, {
      字級: 21,
      顏色: 色票.紙白,
      粗體: true,
      字體: 內文字,
...
async function 做封面(presentation, data) {
  ...
  加文字(slide, 頁碼, data.標題, 84, 118, 660, 144, {
    字級: 66,
    顏色: 色票.紙白,
    粗體: true,
    字體: 標題字,
  ...
  加文字(slide, 頁碼, data.副標題, 90, 290, 560, 58, {
    字級: 34,
    顏色: "#D7E4F2",
    粗體: true,
    字體: 內文字,
  ...
  加文字(slide, 頁碼, "用四個時代轉折，看懂臺南怎麼一路變成今天的樣子。", 90, 388, 580, 66, {
    字級: 24,
    顏色: 色票.淺灰,
    字體: 內文字,
    角色: "封面說明",
  ...
  加圓角卡(slide, 頁碼, 800, 114, 374, 470, "#081A29E8", "#25526E", "封面階段面板");
  加文字(slide, 頁碼, "目錄", 834, 152, 180, 32, {
    字級: 20,
    顏色: 色票.淺青,
    粗體: true,
    字體: 等寬字,
  ...
  data.階段.forEach(([序號, 標題, 說明], index) => {
    const y = 206 + index * 92;
    加圓角卡(slide, 頁碼, 830, y, 314, 72, "#102A40F7", "#21455D", `封面階段卡-${index + 1}`);
    加文字(slide, 頁碼, 序號, 854, y + 16, 42, 28, {
      字級: 22,
      顏色: 色票.青綠,
      粗體: true,
      字體: 標題字,
    ...
    加文字(slide, 頁碼, 標題, 920, y + 12, 184, 26, {
      字級: 21,
      顏色: 色票.紙白,
      粗體: true,
      字體: 內文字,
    ...
    加文字(slide, 頁碼, 說明, 920, y + 40, 198, 22, {
      字級: 14,
      顏色: 色票.淺灰,
      字體: 內文字,
      角色: `封面階段說明-${index + 1}`,
...
async function 做總覽(presentation, data) {
  ...
  加頁碼框(slide, 頁碼, data.標籤);
  加文字(slide, 頁碼, data.標題, 84, 104, 980, 78, {
    字級: 50,
    顏色: 色票.墨黑,
    粗體: true,
    字體: 標題字,
  ...
  加文字(slide, 頁碼, data.副標題, 84, 198, 860, 60, {
    字級: 26,
    顏色: 色票.深海藍,
    字體: 內文字,
    角色: "總覽副標題",
  });
  加形狀(slide, 頁碼, "rect", 132, 356, 1060, 6, 色票.青綠, 色票.透明, 0, "流程主線");
  data.時間線.forEach(([時間, 標題, 說明], index) => {
    const x = 68 + index * 292;
    加圓角卡(slide, 頁碼, x, 390, 270, 228, "#FFFFFFF4", "#C7DDED", `時間線卡-${index + 1}`);
    加形狀(slide, 頁碼, "ellipse", x + 116, 334, 38, 38, 色票.青綠, 色票.透明, 0, `流程節點-${index + 1}`);
    加文字(slide, 頁碼, `${index + 1}`, x + 127, 342, 18, 18, {
      字級: 14,
      顏色: 色票.墨黑,
      粗體: true,
      字體: 標題字,
    ...
    加文字(slide, 頁碼, 時間, x + 22, 414, 220, 24, {
      字級: 15,
      顏色: 色票.青綠,
      粗體: true,
      字體: 等寬字,
    ...
    加文字(slide, 頁碼, 標題, x + 22, 456, 220, 58, {
      字級: 30,
      顏色: 色票.墨黑,
      粗體: true,
      字體: 標題字,
    ...
    加文字(slide, 頁碼, 說明, x + 22, 532, 224, 68, {
      字級: 18,
      顏色: 色票.深海藍,
      字體: 內文字,
      角色: `時間線說明-${index + 1}`,
    ...
    if (index < 3) {
      加形狀(slide, 頁碼, "rect", x + 270, 350, 22, 2, 色票.青綠, 色票.透明, 0, `時間線連接-${index + 1}`);
    }
  });
...
async function 做階段頁(presentation, 頁碼, data, 參考圖) {
  ...
  加文字(slide, 頁碼, data.標題, 84, 180, 640, 124, {
    字級: 48,
    顏色: 色票.紙白,
    粗體: true,
    字體: 標題字,
  ...
  加文字(slide, 頁碼, data.判斷, 84, 330, 650, 82, {
    字級: 28,
    顏色: 色票.淺灰,
    粗體: true,
    字體: 內文字,
  ...
  加條列(slide, 頁碼, data.要點, 84, 448, 720);
  加標籤欄(slide, 頁碼, data.標籤欄, 838, 350, 340);
...
async function 做統整頁(presentation, data) {
  ...
  加頁碼框(slide, 頁碼, data.標籤);
  加文字(slide, 頁碼, data.標題, 84, 108, 980, 76, {
    字級: 48,
    顏色: 色票.紙白,
    粗體: true,
    字體: 標題字,
  ...
  加文字(slide, 頁碼, data.副標題, 84, 198, 900, 60, {
    字級: 25,
    顏色: 色票.淺灰,
    字體: 內文字,
    角色: "統整副標題",
  ...
  data.卡片.forEach(([標題, 變化, 說明], index) => {
    ...
    const accent = index === 1 ? 色票.金色 : index === 2 ? 色票.珊瑚 : 色票.青綠;
    加圓角卡(slide, 頁碼, 92, y, 1088, 96, "#0D2236F2", "#204A65", `統整卡-${index + 1}`);
    加文字(slide, 頁碼, `0${index + 1}`, 122, y + 18, 38, 28, {
      字級: 22,
    ...
    加文字(slide, 頁碼, 標題, 182, y + 16, 220, 28, {
      字級: 22,
      顏色: 色票.紙白,
      粗體: true,
      字體: 內文字,
    ...
    加文字(slide, 頁碼, 變化, 438, y + 16, 420, 34, {
      字級: 24,
      顏色: 色票.紙白,
      粗體: true,
      字體: 標題字,
    ...
    加文字(slide, 頁碼, 說明, 870, y + 18, 270, 42, {
      字級: 17,
      顏色: 色票.淺灰,
      字體: 內文字,
      角色: `統整說明-${index + 1}`,
    });
    加形狀(slide, 頁碼, "rect", 416, y + 22, 4, 52, accent, 色票.透明, 0, `統整分隔-${index + 1}`);
  });
...
async function 做結論頁(presentation, data) {
  ...
  加頁碼框(slide, 頁碼, data.標籤);
  加文字(slide, 頁碼, data.標題, 84, 120, 820, 140, {
    字級: 58,
    顏色: 色票.紙白,
    粗體: true,
    字體: 標題字,
  ...
  加文字(slide, 頁碼, data.句子, 96, 318, 760, 320, {
    字級: 32,
    顏色: 色票.紙白,
    粗體: true,
    字體: 標題字,
